...
$queryJurusan = mysqli_query($conn, "SELECT COUNT(*) as total FROM jurusan");
$jumlahJurusan = mysqli_fetch_assoc($queryJurusan)['total'];

$queryAgama = mysqli_query($conn, "SELECT COUNT(*) as total FROM agama");
$jumlahAgama = mysqli_fetch_assoc($queryAgama)['total'];
?>
...
// Set pesan pop-up berdasarkan role
$popupMessage = $role == 'admin'
    ...
    <div id="logoutModal" class="modal" style="display:none;">
      <div class="modal-content">
        <?php if (isset($_SESSION['username'])): ?>
          ...
          <p>Keluar dari <strong>Website Siswa SMKN 6 SKA</strong> sebagai
