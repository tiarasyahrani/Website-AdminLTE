...
<style>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                                      <table id="tabelAgama" class="table table-striped">
                    <thead>
                      <tr>
                        <th>NO</th>
                        <th>Kode Agama</th>
                      ...
                      ?>
                        <tr>
                          ...
                          <?php if ($_SESSION['role'] === 'admin'): ?>
                            ...
                            <td>
                              <button class="btn btn-primary btn-edit" data-id_agama="<?= $x['id_agama'] ?>"
                                data-nama_agama="<?= $x['nama_agama'] ?>">
                                Edit
                              </button>
                              <button class="btn hapus" onclick="tampilkanPopupHapusAgama(
                                '<?php echo $x['id_agama']; ?>',
                                '<?php echo $x['nama_agama']; ?>'
                              )">
                                Hapus
                              </button>
  ...
  <div id="editModal"
    ...
    <form action="proses_edit_agama.php" method="POST">
      <input type="hidden" id="edit-id_agama" name="id_agama">

      <label for="edit-nama_agama">Nama Agama:</label>
      <input type="text" id="edit-nama_agama" name="nama_agama" required>
  ...
  <div id="popupHapusAgama" class="popup" style="display: none;">
    <div class="popup-content">
      <h3 style="background: #dc3545; color: white; padding: 10px;">Konfirmasi Hapus Agama</h3>
      ...
      <div style="text-align: right;">
        <button onclick="tutupPopupHapusAgama()" class="btn" style="background:#6c757d;">Batal</button>
        <a href="#" id="linkHapusKonfirmasiAgama" class="btn" style="background:#dc3545;">Hapus</a>
      </div>
    </div>
  </div>
  ...
  <script>
    function tampilkanPopupHapusAgama(id_agama, nama_agama) {
      document.getElementById('hapusIdAgama').textContent = id_agama;
      document.getElementById('hapusNamaAgama').textContent = nama_agama;

      document.getElementById('linkHapusKonfirmasiAgama').href = "hapusagama.php?id_agama=" + id_agama + "&aksi=hapus";
      document.getElementById('overlay').style.display = 'block';

      document.getElementById('popupHapusAgama').style.display = 'block';
    }

    function tutupPopupHapusAgama() {
      document.getElementById('popupHapusAgama').style.display = 'none';
  ...
  <script>
    document.querySelectorAll('.btn-edit').forEach(function(button) {
      button.addEventListener('click', function() {
        document.getElementById('edit-id_agama').value = this.dataset.id_agama;
        document.getElementById('edit-nama_agama').value = this.dataset.nama_agama;
