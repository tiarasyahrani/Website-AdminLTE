...
if (isset($_POST['simpan'])) {
  ...
  $query = $db->tambah_siswa($nisn, $nama, $jeniskelamin, $kodejurusan, $kelas, $alamat, $agama, $nohp);
            ...
            <div class="form-column">
              ...
              <div class="radio-group">
                <div class="radio-item">
                  ...
                  <label for="Laki-laki"><i class="fas fa-mars"></i> Laki-laki</label>
                </div>
                <div class="radio-item">
                  <input type="radio" id="Perempuan" name="jeniskelamin" value="P" required>
                  <label for="Perempuan"><i class="fas fa-venus"></i> Perempuan</label>
                </div>
              </div>
