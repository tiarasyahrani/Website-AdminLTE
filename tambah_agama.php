...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  ...
  <div class="app-wrapper">
    ...
    <main class="app-main">
      <div class="container">
        <h2><i class="fas fa-praying-hands"></i> Tambah Agama</h2>
        <form action="tambah_agama.php" method="POST">
          <label for="id_agama">Kode Agama:</label>
          <div class="input-group">
            <i class="fas fa-barcode"></i>
            <input type="text" id="id_agama" name="id_agama" required>
          </div>
