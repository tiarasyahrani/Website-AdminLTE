...
<style>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                                      <table id="tabelJurusan" class="table table-striped">
                    <thead>
                      <tr>
                        <th>NO</th>
                        <th>Kode Jurusan</th>
                          ...
                          <?php if ($_SESSION['role'] === 'admin'): ?>
                            <td>
                              <button class="btn btn-primary btn-edit"
                                ...
                                data-namajurusan="<?= $x['namajurusan'] ?>">
                                Edit
                              </button>
                              <button class="btn hapus" onclick="tampilkanPopupHapusJurusan(
                              '<?= $x['kodejurusan'] ?>',
                              '<?= $x['namajurusan'] ?>'
                            )">
                                Hapus
  ...
  <div id="editModal"
    ...
    <form action="proses_edit_jurusan.php" method="POST">
      <input type="hidden" id="edit-kodejurusan" name="kodejurusan">

      <label for="edit-namajurusan">Nama Jurusan:</label>
      <input type="text" id="edit-namajurusan" name="namajurusan" required>
  ...
  <div id="popupHapusJurusan" class="popup" style="display: none;">
    <div class="popup-content">
      ...
      <div style="text-align: right;">
        <button onclick="tutupPopupHapusJurusan()" class="btn" style="background:#6c757d;">Batal</button>
        <a href="#" id="linkHapusKonfirmasiJurusan" class="btn" style="background:#dc3545;">Hapus</a>
      </div>
    </div>
  </div>
  ...
  <script>
    function tampilkanPopupHapusJurusan(kodejurusan, namajurusan) {
      document.getElementById('hapusKodeJurusan').textContent = kodejurusan;
      document.getElementById('hapusNamaJurusan').textContent = namajurusan;

      document.getElementById('linkHapusKonfirmasiJurusan').href = "hapusjurusan.php?kodejurusan=" + kodejurusan + "&aksi=hapus";
      document.getElementById('overlay').style.display = 'block';

      document.getElementById('popupHapusJurusan').style.display = 'block';
    }

    function tutupPopupHapusJurusan() {
      document.getElementById('popupHapusJurusan').style.display = 'none';
  ...
  <script>
    document.querySelectorAll('.btn-edit').forEach(function(button) {
      button.addEventListener('click', function() {
        ...
        document.getElementById('edit-namajurusan').value = this.dataset.namajurusan;
        document.getElementById('overlay').style.display = 'block';
